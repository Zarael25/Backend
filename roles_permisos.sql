...
-- Escritura limitada: solo puede insertar o actualizar ciertos registros
GRANT INSERT, UPDATE ON TABLE usuarios_usuario TO acceso_publico;
GRANT INSERT, UPDATE ON TABLE negocios_negocio TO acceso_publico;  -- si permite crear su propio negocio
GRANT INSERT, UPDATE ON TABLE negocios_filaatencion TO acceso_publico;  -- si permite crear filas
GRANT INSERT ON TABLE negocios_ticket TO acceso_publico;  -- generar tickets
...
-- Asegurar que tablas nuevas también permitan lectura
ALTER DEFAULT PRIVILEGES IN SCHEMA public
GRANT SELECT ON TABLES TO acceso_publico;
